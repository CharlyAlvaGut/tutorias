...
public class UsuarioService implements IUsuarioService {
	...
	@Override
	public List<UsuarioDTO> obtenerPorClase(Integer clase) {

		List<Object[]> resultados = repoUsuarios.obtenerUsuariosPorClases(clase);

		return resultados.stream().map(r -> new UsuarioDTO(((Number) r[0]).intValue(), 
				(String) r[1], 
				(String) r[2] 
		)).toList();
